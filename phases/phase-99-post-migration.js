...
module.exports = async function phase99(v1Pool, v2Pool) {
  ...
  // =============================================
  // 0b. SKIP - Remapeo de roles deshabilitado (2026-05-19)
  // =============================================
  // El usuario maneja roles manualmente desde admin v2 desde mig 019
  // (consolidacion 94->27 roles). Phase-03 ya asigna 'customer' o
  // 'asistente' como defaults en INSERTs nuevos, y NO sobrescribe
  // role_id en UPDATEs (preserva ajustes manuales).
  logger.info('\nPaso 0b: SKIP — remapeo de roles desactivado (manejado manualmente desde admin v2).');
